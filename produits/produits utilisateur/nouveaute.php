...
<nav class="navbar">
  ...
  <div class="navbar-actions">
    ...
    <a href="../../panier/affiche_panier.php" class="cart-btn" title="Mon panier">
      ...
      <span class="cart-badge" id="cartCount"><?php
        require '../../liaison.php';
        $ref_uti=4;
        try {
    ...
    <div class="profile-wrap" id="profileWrap">
      ...
      <?php if (isset($_SESSION['ref_uti']) && $_SESSION['role'] === 'client'): ?>
        ...
        <div class="profile-dropdown" id="profileDropdown">
          ...
          <a href="../../panier/histo.php">
            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>
            Mes commandes
          </a>
          <hr class="dropdown-divider" />
          <a href="../../Authentification/logout_client.php" class="logout-btn">
      ...
      <?php else: ?>
        <!-- Non connecté -->
        <a href="../../Authentification/connect_client.php" class="profile-btn" title="Connexion / Inscription">
    ...
    <div class="hero-count">
      <p id="heroCount"><?php
        ...
        try {
          ...
          $stmt = $com->prepare("SELECT COUNT(idprod) AS nb FROM produit JOIN categorie ON produit.id_cat = categorie.id_cat WHERE categorie.nom = ? ");
          $stmt->execute([$cate]);
        }else {
            $stmt = $com->query("SELECT COUNT(idprod) AS nb FROM produit");
        }
        $row = $stmt->fetch(PDO::FETCH_ASSOC);
          echo $row['nb'];
      ...
      try{
        if (isset($_POST['cate_retour']) && ($_SERVER["REQUEST_METHOD"] == "POST")){
          ...
          $stmt->execute([$cate]);
           ...
           <div class="card">
        <div class="card-img">
          <button class="hidden" formaction="../../panier/detai.php">
        ...
        <div class="card-body">
          ...
          <div class="card-actions">
            <button class="btn-cart-overlay" name="ajouter" formaction="../../panier/affiche_panier.php">
