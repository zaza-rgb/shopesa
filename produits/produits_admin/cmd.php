<?php
       ...
       if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['valider'])) {
            $stmt = $com->prepare("UPDATE commande SET statut='validee' WHERE id_commande=?");
...
<body>
  ...
  <aside class="sidebar">
    ...
    <nav class="nav-section">
      ...
      <a href="cmd.php" class="nav-link active">
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
          ...
          <tr>
            <td class="order-id"><?php echo htmlspecialchars($row['id_commande_produit']); ?></td>
            <td><?php echo htmlspecialchars($row['ref_uti']); ?></td>
            <td><?php echo htmlspecialchars($row['idprod']); ?></td>
            <td><?php echo htmlspecialchars($row['prix_unitaire']); ?></td>
            <td><?php echo htmlspecialchars($row['quantite']); ?></td>
            <td><?php echo htmlspecialchars($row['statut']); ?></td>
            <td><?php echo htmlspecialchars($row['date_commande']); ?></td>
            <td> 
            <input type="hidden" name="id_commande" value="<?php echo htmlspecialchars($row['id_commande']); ?>">
            <input type="hidden" name="id_commande_produit" value="<?php echo htmlspecialchars($row['id_commande_produit']); ?>">
            <?php if ($row['statut']=='en_attente'){
              ?>
                 <input type="hidden" name="ref_uti" value="<?php echo htmlspecialchars($row['ref_uti']); ?>">
                <button class="delete-link" name="valider" title="valider" formaction="">valider</button>
              <?php
            }?>
        </td>
          </tr>
