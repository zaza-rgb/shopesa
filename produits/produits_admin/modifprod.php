...
<main class="main">
    ...
    <div class="page-header">
      ...
      <div>
        <h2>modifier un produit <?php require '../../liaison.php';
    ...
    if (isset($_FILES['image']) && $_FILES['image']['error'] == 0) {
        ...
        if (move_uploaded_file($_FILES["image"]["tmp_name"], $target_file)) {
            $stmt = $com->prepare("UPDATE  produit SET nomprod = ?, prix = ?, description = ?, image = ?, seuil = ?, stock = ?, statut = ?, id_cat = ? WHERE idprod = ?");
        if ($stmt->execute([$nomp, $prix, $description, $image, $seuil, $stock, $statut, $categorie, $idprod])) {
                echo "     ---notification:Produit modifié avec succès !";
            } else {
...
?>
    ...
    <form method="POST" action="modifprod.php" enctype="multipart/form-data">
    <div class="content-grid">
      ...
      <div class="preview-card">
        ...
        <hr class="divider" />
        <button class="btn-create">modifier le produit</button>
