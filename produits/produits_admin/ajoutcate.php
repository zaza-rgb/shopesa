...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $com->prepare("INSERT INTO categorie (nom, descri) VALUES (?, ?)");

    if ($stmt->execute([$nomp, $description])) {
...
<?php if(isset($message)) echo "<p>$message</p>"; ?>
        <p>Créez une nouvelle categorie dans votre catalogue</p>
      </div>
    </div>
    <form method="POST">
    <div class="content-grid">
      ...
      <div>
        ...
        <div class="card">
          ...
          <div class="field">
            <label>Nom de la categorie <span class="req">*</span></label>
            <input name="nom" type="text" placeholder="Ex: Vetement" required>
          </div>

          
          <div class="field">
            <label>Description <span class="req">*</span></label>
            <textarea name="description" placeholder="Décrivez votre categorie en détail..." required></textarea>
          </div>
        <hr class="divider" />
        <button class="btn-create">Créer la categorie</button>
...
<script>
  ...
  function updatePreview() {
    ...
    el('prev-stock', description);


    
  }

  document.querySelectorAll('input[name="nom"], textarea[name="description"]')
