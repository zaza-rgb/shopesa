  ...
  <main class="main">
    ...
    <div class="stats-grid">
      <div class="stat-card">
        ...
        $total=0;
        try {
    $stmt = $com->prepare("SELECT quantite,prix_unitaire FROM commande_produit");
    $stmt->execute();
    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
      ...
      <div class="stat-card">
        ...
        require '../../liaison.php';
        try {
    $stmt = $com->prepare("SELECT COUNT(id_commande_produit) AS nb FROM commande_produit");
    $stmt->execute();
    $row = $stmt->fetch(PDO::FETCH_ASSOC);
      ...
      <div class="stat-card">
        ...
        require '../../liaison.php';
        try {
    $stmt = $com->prepare("SELECT COUNT(ref_uti) AS nb FROM utilisateur where role ='client'");
    $stmt->execute();
    $row = $stmt->fetch(PDO::FETCH_ASSOC);
          echo $row['nb'];
      ...
      <div class="stat-card">
        ...
        require '../../liaison.php';
        try {
    $stmt = $com->prepare("SELECT COUNT(idprod) AS nb FROM produit");
    $stmt->execute();
    $row = $stmt->fetch(PDO::FETCH_ASSOC);
          echo $row['nb'];
    ...
    <div class="table-card">
      <h3>toute les Commandes recentes</h3>
      <table>
        <thead>
          <tr>
            <th>Commande</th>
    ...
    ORDER BY cp.id_commande_produit DESC
    LIMIT 30
");
$stmt->execute();
