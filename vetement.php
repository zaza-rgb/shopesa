...
<head>
  ...
  <title>ShopStyle – Vêtements</title>
...
<body>
  ...
  <section class="page-banner">
    <div>
      <h1>Vêtements</h1>
      <p>Explorez notre collection de vêtements tendance</p>
    </div>
  </section>
  ...
  <section class="products">
    <div class="products-header">
      <h2>Vêtements</h2>
      <div class="filters">
        <a href="tous.php" class="filter-btn">Tous</a>
        <a href="vetements.php" class="filter-btn active">Vêtements</a>
    ...
    <div class="grid">
      <?php
        require '../liaison.php';
        try {
          $stmt = $pdo->prepare("SELECT produit.*, categorie.nom FROM produit LEFT JOIN categorie ON produit.id_cat = categorie.id_cat WHERE categorie.nom = ? AND produit.statut = 'actif'");
          $stmt->execute(['Vêtements']);
          $produits = $stmt->fetchAll(PDO::FETCH_ASSOC);

          if (count($produits) === 0) {
            echo "<p class='empty-msg'>Aucun produit dans cette catégorie pour le moment.</p>";
          } else {
        ...
        <form method="post" action="../panier/selectSQL.php">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <p class="card-cat"><?php echo htmlspecialchars($row['nom']); ?></p>
